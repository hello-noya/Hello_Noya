...
import { Trash2, Target, ListTodo, Target as GoalIcon } from 'lucide-react';
import { useApp } from '../../context/AppContext';
import { ConfirmDialog } from '../ui/ConfirmDialog';

interface ManageAllContentProps {
  onClose: () => void;
}

export function ManageAllContent({ onClose }: ManageAllContentProps) {
