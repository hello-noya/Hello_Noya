...
// 15 корейских lo-fi треков для учёбы
const TRACKS: Track[] = [
  {
    name: '1 A.M. with You — Kim-Dog Jr.',
    chords: [
      [261.63, 329.63, 392.00, 493.88], // Cmaj7 — мягкий гитарный перебор
      [349.23, 440.00, 523.25, 659.25], // Fmaj7
      [220.00, 261.63, 329.63, 392.00], // Am7
      [196.00, 246.94, 293.66, 349.23], // G7
    ],
    progression: [0, 2, 1, 3, 0, 2],
    bpm: 68,
    mood: 'chill',
  },
  {
    name: 'Monday Morning Playlist — Korean Rain',
    chords: [
      [293.66, 349.23, 440.00, 523.25], // Dm7 — лёгкий ритм
  ...
  {
    name: 'forbidden love — Korea Chill Lofi',
    chords: [
      [220.00, 261.63, 329.63, 392.00], // Am7 — азиатские мотивы
      [174.61, 220.00, 261.63, 329.63], // Fm7
      [233.08, 293.66, 349.23, 440.00], // Bbmaj7
      [196.00, 246.94, 293.66, 349.23], // G7
    ],
    progression: [0, 1, 2, 3, 1, 0],
    bpm: 64,
    mood: 'dreamy',
  },
  {
    name: 'Aesthetic Songs — Korean Rain',
    chords: [
      [261.63, 311.13, 392.00, 466.16], // Cm7 — минималистичный
      [220.00, 261.63, 329.63, 392.00], // Am7
      [233.08, 293.66, 349.23, 440.00], // Bbmaj7
      [196.00, 246.94, 293.66, 349.23], // G7
    ],
  ...
  {
    name: 'Be Yourself — Penicillin MC',
    chords: [
      [196.00, 246.94, 293.66, 349.23], // G7 — глубокий бас
      [220.00, 261.63, 329.63, 392.00], // Am7
      [174.61, 220.00, 261.63, 329.63], // Fm7
      [164.81, 207.65, 246.94, 311.13], // Em7
    ],
    progression: [0, 1, 2, 3, 2, 1, 0],
    bpm: 62,
    mood: 'warm',
  },
  {
    name: 'Korean Rain — Aesthetic Songs',
    chords: [
      [349.23, 440.00, 523.25, 659.25], // Fmaj7 — капли дождя
  ...
  {
    name: 'autumn breeze — Korea Chill Lofi',
    chords: [
      [220.00, 261.63, 329.63, 392.00], // Am7 — светлая меланхолия
  ...
  {
    name: 'In the Calm — Sugi Zo',
    chords: [
      [311.13, 392.00, 466.16, 587.33], // Ebmaj7 — медитативный
  ...
  {
    name: 'Orchard — Korea Chill Lofi',
    chords: [
      [261.63, 329.63, 392.00, 493.88], // Cmaj7 — виниловый звук
      [349.23, 440.00, 523.25, 659.25], // Fmaj7
      [293.66, 349.23, 440.00, 523.25], // Dm7
      [196.00, 246.94, 293.66, 349.23], // G7
    ],
  ...
  {
    name: 'Snowfall — Sun Dusk',
    chords: [
      [233.08, 293.66, 349.23, 440.00], // Bbmaj7 — атмосферный
  ...
  {
    name: 'Fiery Guitar — Kim-Dog Jr.',
    chords: [
      [220.00, 261.63, 329.63, 392.00], // Am7 — гитарное соло R&B
      [196.00, 246.94, 293.66, 349.23], // G7
      [174.61, 220.00, 261.63, 329.63], // Fm7
      [233.08, 293.66, 349.23, 440.00], // Bbmaj7
    ],
    progression: [0, 1, 2, 3, 1, 0, 2, 3],
    bpm: 66,
    mood: 'warm',
  },
  {
    name: 'Mountains — Korea Chill Lofi',
    chords: [
      [261.63, 311.13, 392.00, 466.16], // Cm7 — глубокий, поток
  ...
  {
    name: 'Reminiscent — Mark Bos',
    chords: [
      [311.13, 392.00, 466.16, 587.33], // Ebmaj7 — ностальгические клавишные
      [261.63, 311.13, 392.00, 466.16], // Cm7
      [349.23, 440.00, 523.25, 659.25], // Fmaj7
      [293.66, 349.23, 440.00, 523.25], // Dm7
    ],
    progression: [0, 2, 1, 3, 0, 1],
    bpm: 64,
    mood: 'dreamy',
  },
  {
    name: 'Army Time — Lofi Origin',
    chords: [
      [293.66, 349.23, 440.00, 523.25], // Dm7 — чёткий ритм
      [261.63, 329.63, 392.00, 493.88], // Cmaj7
      [349.23, 440.00, 523.25, 659.25], // Fmaj7
      [196.00, 246.94, 293.66, 349.23], // G7
    ],
  ...
  {
    name: 'Sheer Happiness — Tobacco Music',
    chords: [
      [261.63, 329.63, 392.00, 493.88], // Cmaj7 — уютный финал
      [349.23, 440.00, 523.25, 659.25], // Fmaj7
      [220.00, 261.63, 329.63, 392.00], // Am7
      [196.00, 246.94, 293.66, 349.23], // G7
    ],
