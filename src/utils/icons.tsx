...
// K-pop style icons - мягкие, округлые, милые
export const IconComponents: Record<string, React.FC<IconProps>> = {
  ...
  book: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" fill={color} fillOpacity="0.1"/>
  ...
  run: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="5" r="2" fill={color} fillOpacity="0.2"/>
  ...
  apple: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2c-1-1-3-1-4 0s-1 3 0 4c-3 0-6 3-6 7s3 9 7 9c1 0 2-1 3-1s2 1 3 1c4 0 7-5 7-9s-3-7-6-7c1-1 1-3 0-4s-3-1-4 0z" fill={color} fillOpacity="0.2"/>
      <path d="M12 2c-1-1-3-1-4 0s-1 3 0 4c-3 0-6 3-6 7s3 9 7 9c1 0 2-1 3-1s2 1 3 1c4 0 7-5 7-9s-3-7-6-7c1-1 1-3 0-4s-3-1-4 0z"/>
    </svg>
  ),
  brain: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2a5 5 0 0 0-5 5c0 1 .3 2 .8 2.8A5 5 0 0 0 7 14a5 5 0 0 0 5 5 5 5 0 0 0 5-5c0-1.5-.5-2.9-1.3-4A5 5 0 0 0 17 7a5 5 0 0 0-5-5z" fill={color} fillOpacity="0.2"/>
  ...
  music: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 18V5l12-2v13" fill={color} fillOpacity="0.1"/>
      <path d="M9 18V5l12-2v13"/>
      <circle cx="6" cy="18" r="3" fill={color} fillOpacity="0.3"/>
      <circle cx="6" cy="18" r="3"/>
      <circle cx="18" cy="16" r="3" fill={color} fillOpacity="0.3"/>
  ...
  gym: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <rect x="2" y="8" width="4" height="8" rx="1" fill={color} fillOpacity="0.2"/>
      <rect x="2" y="8" width="4" height="8" rx="1"/>
      <rect x="18" y="8" width="4" height="8" rx="1" fill={color} fillOpacity="0.2"/>
      <rect x="18" y="8" width="4" height="8" rx="1"/>
    </svg>
  ),
  coffee: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17 8h1a4 4 0 1 1 0 8h-1" fill={color} fillOpacity="0.1"/>
      <path d="M17 8h1a4 4 0 1 1 0 8h-1"/>
      <path d="M3 8h14v9a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V8z" fill={color} fillOpacity="0.2"/>
  ...
  laptop: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="4" width="18" height="12" rx="2" fill={color} fillOpacity="0.1"/>
  ...
  star: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} fillOpacity="0.3" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  leaf: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} fillOpacity="0.2" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.96c1.4 9.3-3.2 14.5-8.2 17.04z"/>
