...
// SVG-иконки для привычек и профиля — по делу, без декоративных сердечек/цветочков
// Каждая иконка — это реальное действие/объект
...
export const HabitIcons: Record<string, React.FC<IconProps>> = {
  ...
  run: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M10.5 22l2-7 3.5 3 4-4"/>
      <path d="M6 22l2.5-6L5 13l3-3"/>
    </svg>
  ),
  yoga: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  apple: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2c-1 0-2 1-2 2"/>
      <path d="M17 6c-2-2-5-2-7 0s-5 2-7 0"/>
      <path d="M5 8c-2 6 1 14 7 14s9-8 7-14"/>
      <path d="M12 8v14"/>
    </svg>
  ),
  ...
  walk: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="13" cy="4" r="2"/>
      <path d="M10 22l2-6 3 2 3-4"/>
      <path d="M7 22l3-8 4-2"/>
    </svg>
  ),
  meditate: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  stretch: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="4" r="2"/>
      <path d="M12 6v4"/>
...
// Profile icons — сокращённый набор (12 штук), тоже по делу
export const ProfileIcons: Record<string, React.FC<IconProps>> = {
  ...
  crown: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 20h20"/>
      <path d="m2 8 5 5 5-9 5 9 5-5v12H2z"/>
    </svg>
  ),
  ...
  leaf: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.3c1 3.2.5 7.3-2 11"/>
...
export const HABIT_ICON_KEYS = Object.keys(HabitIcons);
export const PROFILE_ICON_KEYS = Object.keys(ProfileIcons);

// Функция рендера иконки по ключу
export function renderIcon(key: string, size = 20, color = 'currentColor'): React.ReactNode {
  const IconComponent = HabitIcons[key] || ProfileIcons[key];
