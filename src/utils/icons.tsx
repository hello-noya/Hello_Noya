...
export const IconComponents: Record<string, React.FC<IconProps>> = {
  ...
  water: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3c-2 3-5 6-5 10a5 5 0 0 0 10 0c0-4-3-7-5-10z" fill={color} fillOpacity="0.1"/>
      <path d="M12 3c-2 3-5 6-5 10a5 5 0 0 0 10 0c0-4-3-7-5-10z"/>
    </svg>
  ),
  book: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 4.5A2.5 2.5 0 0 1 6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15z" fill={color} fillOpacity="0.08"/>
  ...
  run: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="13" cy="4" r="2" fill={color} fillOpacity="0.15"/>
  ...
  apple: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2c-1.5-1-3-1-4 0s-1 3 0 4c-3 0-6 3-6 7s3 9 7 9c1 0 2-1 3-1s2 1 3 1c4 0 7-5 7-9s-3-7-6-7c1-1 1-3 0-4s-2.5-1-4 0z" fill={color} fillOpacity="0.12"/>
  ...
  brain: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2a5 5 0 0 0-5 5c0 1 .3 2 .8 2.8A5 5 0 0 0 7 14a5 5 0 0 0 5 5 5 5 0 0 0 5-5c0-1.5-.5-2.9-1.3-4A5 5 0 0 0 17 7a5 5 0 0 0-5-5z" fill={color} fillOpacity="0.1"/>
  ...
  music: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 18V5l12-2v13" fill={color} fillOpacity="0.08"/>
  ...
  gym: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <rect x="2" y="8" width="4" height="8" rx="1" fill={color} fillOpacity="0.15"/>
      <rect x="2" y="8" width="4" height="8" rx="1"/>
      <rect x="18" y="8" width="4" height="8" rx="1" fill={color} fillOpacity="0.15"/>
      <rect x="18" y="8" width="4" height="8" rx="1"/>
    </svg>
  ),
  coffee: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17 8h1a4 4 0 1 1 0 8h-1" fill={color} fillOpacity="0.08"/>
      <path d="M17 8h1a4 4 0 1 1 0 8h-1"/>
      <path d="M3 8h14v9a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V8z" fill={color} fillOpacity="0.12"/>
  ...
  laptop: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="4" width="18" height="12" rx="2" fill={color} fillOpacity="0.08"/>
  ...
  crown: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} fillOpacity="0.15" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  rocket: ({ size = 20, color = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} fillOpacity="0.12" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
